<template>
  <div class="card my-16 mr-25 pr-20 outlined">
    ...
    <section>
      <table>
        ...
        <tbody v-if="cart.items">
          ...
          >
            ...
            <td data-testid="cart-item-quantity">
              {{ cartItem.cartQuantity }}
            </td>
            <td class="numeric" data-testid="cart-item-price">
              ${{ cartItem.price }}
            </td>
          </tr>
        </tbody>
      ...
      <div
        class="layout-row justify-content-between align-items-center px-8 mx-12"
      >
        <h5>Select Coupon</h5>
        <select
      ...
      <ul class="bordered inset ma-0 px-8 mt-30">
        ...
        >
          <span>Discount (-)</span>
          <span class="discount" data-testid="cart-discount"
            >${{ cart.discount }}</span
          >
        </li>
